...
#if !defined (__thekogans_stream_namedpipeecho_server_Options_h)
#define __thekogans_stream_namedpipeecho_server_Options_h
...
#endif // !defined (__thekogans_stream_namedpipeecho_server_Options_h)
