...
#include "thekogans/securetcpecho/server/Options.h"
#include "thekogans/securetcpecho/server/Version.h"
#include "thekogans/securetcpecho/server/Server.h"
...
int main (
    ...
    else if (server::Options::Instance ().path.empty ()) {
