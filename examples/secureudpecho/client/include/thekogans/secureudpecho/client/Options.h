...
#if !defined (__thekogans_stream_secureudpecho_client_Options_h)
#define __thekogans_stream_secureudpecho_client_Options_h
...
#endif // !defined (__thekogans_stream_secureudpecho_client_Options_h)
