            ...
            namespace server {
                ...
                const thekogans::util::Version &GetVersion () {
                    static const thekogans::util::Version version (
                        THEKOGANS_STREAM_SECUREUDPECHO_SERVER_MAJOR_VERSION,
                        THEKOGANS_STREAM_SECUREUDPECHO_SERVER_MINOR_VERSION,
                        THEKOGANS_STREAM_SECUREUDPECHO_SERVER_PATCH_VERSION);
                    return version;
                }
