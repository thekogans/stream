...
#if !defined (__thekogans_stream_serverudpecho_server_Server_h)
#define __thekogans_stream_serverudpecho_server_Server_h
...
#endif // !defined (__thekogans_stream_serverudpecho_server_Server_h)
