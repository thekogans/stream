...
namespace thekogans {
    namespace stream {
        ...
        ///
        /// \brief
        /// ClientTCPSocket exposes an OpenInfo you can use to create client
        ...
        /// TCPSocket. (as a mater of fact, ClientTCPSocket::OpenInfo::CreateStream
        ...
        struct _LIB_THEKOGANS_STREAM_DECL ClientTCPSocket : public TCPSocket {
            ...
            /// \struct ClientTCPSocket::OpenInfo ClientTCPSocket.h thekogans/stream/ClientTCPSocket.h
            ///
            /// \brief
            /// ClientTCPSocket::OpenInfo represents the state
            ...
            /// ClientTCPSocket::OpenInfo. Call OpenInfo::CreateStream () to
            ...
            struct _LIB_THEKOGANS_STREAM_DECL OpenInfo : Stream::OpenInfo {
                ...
                /// \brief
                /// ctor. Parse the node representing a ClientTCPSocket::OpenInfo.
                /// \param[in] node pugi::xml_node representing
                /// a ClientTCPSocket::OpenInfo.
                explicit OpenInfo (const pugi::xml_node &node) :
                        Stream::OpenInfo (VALUE_CLIENT_TCP_SOCKET),
                ...
                /// \brief
                /// Parse the node representing a ClientTCPSocket::OpenInfo.
                /// \param[in] node pugi::xml_node representing
                /// a ClientTCPSocket::OpenInfo.
