...
namespace thekogans {
    namespace stream {
        ...
        struct _LIB_THEKOGANS_STREAM_DECL ServerUDPSocket : public UDPSocket {
        ...
        #if defined (THEKOGANS_STREAM_HAVE_PUGIXML)
            /// \struct ServerUDPSocket::OpenInfo UDPSocket.h thekogans/stream/ServerUDPSocket.h
            ///
            /// \brief
            /// ServerUDPSocket::OpenInfo represents the state
            ...
            /// ServerUDPSocket::OpenInfo. Call OpenInfo::CreateStream () to recreate a
            ...
            struct _LIB_THEKOGANS_STREAM_DECL OpenInfo : Stream::OpenInfo {
                ...
                /// a UDPSocket::OpenInfo.
                explicit OpenInfo (const pugi::xml_node &node) :
                        Stream::OpenInfo (VALUE_SERVER_UDP_SOCKET),
